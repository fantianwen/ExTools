...
def saveSGF(str,winner):
    ...
    timestamp = now.strftime("v2_15_%Y%m%d%H%M%S")
...
LEELAZ_v2_15 = ["/home/ikeda-05444/users/fan/GoProjects/leelaz_v2_15", "--gtp", "-w", "/home/ikeda-05444/users/fan/GoProjects/13x13_backup.txt","-p","1600","--noponder"]
...
white = GTPFacade("white", LEELAZ_v2_15)
 # white = GTPFacade("white", GNUGO_LEVEL_ONE)
