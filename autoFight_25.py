...
def saveSGF(str,winner):
    ...
    timestamp = now.strftime("v2_25_%Y%m%d%H%M%S")
...
LEELAZ_v2_25 = ["/home/ikeda-05444/users/fan/GoProjects/leelaz_v2_25", "--gtp", "-w", "/home/ikeda-05444/users/fan/GoProjects/13x13_backup.txt","-p","1600","--noponder"]
