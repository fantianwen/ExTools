...
def saveSGF(str,winner):
    ...
    timestamp = now.strftime("v2%Y%m%d%H%M%S")
...
LEELAZ = ["/home/ikeda-05444/users/fan/GoProjects/laalaz13E/build/leelaz_08", "--gtp", "-w", "/home/ikeda-05444/users/fan/GoProjects/13x13.txt","-p","1600","--noponder"]
...
LEELAZ_v2_25 = ["/home/ikeda-05444/users/fan/GoProjects/leelaz_v3_25", "--gtp", "-w", "/home/ikeda-05444/users/fan/GoProjects/leelaz-model-v2-7236000.txt","-p","1600","--noponder"]
...
white = GTPFacade("white", LEELAZ_v2_25)
 # white = GTPFacade("white", GNUGO_LEVEL_ONE)
