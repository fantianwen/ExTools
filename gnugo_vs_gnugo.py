...
LEELAZ = ["/home/ikeda-05444/users/fan/GoProjects/leelaz_08", "--gtp", "-w", "/home/ikeda-05444/users/fan/GoProjects/13x13_backup.txt","-p","1600","--noponder"]
LEELAZ_NORMAL_V2 = ["/home/ikeda-05444/users/fan/GoProjects/leela13_normal", "--gtp", "-w", "/home/ikeda-05444/users/fan/GoProjects/13x13_backup.txt","-p","1600","--noponder"]
...
LEELAZ_NORMAL_v2 = ["/home/ikeda-05444/users/fan/GoProjects/leelaz_v2_25", "--gtp", "-w", "/home/ikeda-05444/users/fan/GoProjects/leelaz-model-v2-7236000.txt","-p","1600","--noponder"]
...
black = GTPFacade("black", LEELAZ_NORMAL_V2)
 # white = GTPFacade("white", GNUGO_LEVEL_ONE)
...
# white.showboard()
    ...
    if lastWhiteMove == "" or "resign" in lastWhiteMove or "illegal" in lastWhiteMove:
        saveSGF(white.printSgf(), "B")
        break
